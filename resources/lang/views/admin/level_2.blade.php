...
<tr>
	...
	<table style="padding: 0 !important; border: none !important;  background-color: #E0E0E0; " width="100%">
		<tr height=25>
		<td width=170 align=center colspan=3> <button class="button buttonPV" style="width: 150; color: black; font-size: 11px;"><div >&nbsp;Meter 7</div></button></td>
		</tr>
		<tr height=15>
        ...
        @csrf      
<input type="hidden"  name="customer" value="705">
...
<tr>
	...
	<table style="padding: 0 !important; border: none !important;  background-color: #E0E0E0; " width="100%">
		<tr height=25>
		<td width=170 align=center colspan=3> <button class="button buttonPV" style="width: 150; color: black; font-size: 11px;"><div >&nbsp;Meter 10</div></button></td>
		</tr>
		<tr height=15>
			<td width=80 align=right><button class="button buttonCaption">Customer Name</button></td>
		...
		<form method="POST" action="customer_1">
        @csrf      
<input type="hidden"  name="customer" value="1005">
...
<tr>
	...
	<table style="padding: 0 !important; border: none !important;  background-color: #E0E0E0; " width="100%">
		<tr height=25>
		<td width=170 align=center colspan=3> <button class="button buttonPV" style="width: 150; color: black; font-size: 11px;"><div >&nbsp;Meter 12</div></button></td>
		</tr>
		<tr height=15>
			<td width=80 align=right><button class="button buttonCaption">Customer Name</button></td>
		...
		<form method="POST" action="customer_1">
        @csrf      
<input type="hidden"  name="customer" value="1205">
...
<tr>
	...
	<table style="padding: 0 !important; border: none !important;  background-color: #E0E0E0; " width="100%">
		<tr height=25>
		<td width=170 align=center colspan=3> <button class="button buttonPV" style="width: 150; color: black; font-size: 11px;"><div >&nbsp;Meter 8</div></button></td>
		</tr>
		<tr height=15>
			<td width=80 align=right><button class="button buttonCaption">Customer Name</button></td>
		...
		<form method="POST" action="customer_1">
        @csrf      
<input type="hidden"  name="customer" value="805">
...
<tr>
	...
	<table style="padding: 0 !important; border: none !important;  background-color: #E0E0E0; " width="100%">
		<tr height=25>
		<td width=170 align=center colspan=3> <button class="button buttonPV" style="width: 150; color: black; font-size: 11px;"><div >&nbsp;Meter 11</div></button></td>
		</tr>
		<tr height=15>
			<td width=80 align=right><button class="button buttonCaption">Customer Name</button></td>
		...
		<form method="POST" action="customer_1">
        @csrf      
<input type="hidden"  name="customer" value="1105">
...
<tr>
	...
	<table style="padding: 0 !important; border: none !important;  background-color: #E0E0E0; " width="100%">
		<tr height=25>
		<td width=170 align=center colspan=3> <button class="button buttonPV" style="width: 150; color: black; font-size: 11px;"><div >&nbsp;Meter 13</div></button></td>
		</tr>
		<tr height=15>
			<td width=80 align=right><button class="button buttonCaption">Customer Name</button></td>
		...
		<form method="POST" action="customer_1">
        @csrf      
<input type="hidden"  name="customer" value="1305">
...
<table style="padding: 0 !important; border: none !important;  background-color: #E0E0E0; " width="100%">
		<tr height=25>
		<td width=170 align=center colspan=3> <button class="button buttonPV" style="width: 150; color: black; font-size: 11px;"><div >&nbsp;Meter 9</div></button></td>
		</tr>
		<tr height=15>
			<td width=80 align=right><button class="button buttonCaption">Customer Name</button></td>
		...
		<form method="POST" action="customer_1">
        @csrf      
<input type="hidden"  name="customer" value="905">
