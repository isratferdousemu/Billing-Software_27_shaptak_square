...
// service start
  ...
  // service start
          ...
          ->where('year',$year)
          ->where('level',1)
          ->update(['value_4'=> $dpdc_1,'StationId'=>$dpdc_1]);
          ...
          ->where('year',$year)
          ->where('level',2)
          ->update(['value_4'=> $dpdc_2,'StationId'=>$dpdc_2]);
          ...
          ->where('year',$year)
          ->where('level',3)
          ->update(['value_4'=> $dpdc_3,'StationId'=>$dpdc_3]);
          ...
          ->where('month',$month)
          ->where('year',$year)
          ->update(['value_4'=>DB::Raw('value_4*unit*unit_2')]);
...
DB::table('shop_details')
  ...
  ->update(['unit_2'=>$unit_1]);}
    ...
    ->update(['unit_3'=>0,'unit_2'=>$unit_1]);
                ...
                ->get();
                return view('admin.bill_shop',compact('emu','month3','issue','newDate1','service'));
            }     
                break;
